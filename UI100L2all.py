...
def main(page: ft.Page):
    ...
    sub_bloques_dict = {
        "B6": [
            ...
            {"nombre": "B02", "color": ft.Colors.BLUE_100, "contenido": "B02: Català."},
            ...
            {"nombre": "B05", "color": ft.Colors.BLUE_100, "contenido": "B05: Tecnología y Digitalización."},
        ...
        "P6": [
            ...
            {"nombre": "P02", "color": ft.Colors.GREEN_100, "contenido": "P02: Profesor/a de Matemáticas."}
        ],
        "A4": [
        ...
        "Act": [
            {"nombre": "Act01", "color": ft.Colors.PURPLE_100, "contenido": "Act01: Actividad de Inglés."},
            {"nombre": "Act02", "color": ft.Colors.PURPLE_100, "contenido": "Act02: Actividad de Matemáticas."}
        ]
    }

    # Carpetas para cada sub-bloque
    carpetas = ["Datos", "Material", "In_mensajes"]
    ...
    for bloque in bloques:
        ...
        for sub in sub_bloques:
            ...
            for carpeta in carpetas:
                ...
                # Contenido de ejemplo para cada carpeta
